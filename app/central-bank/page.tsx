        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1.1fr)]">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 p-4 space-y-4">
              ...
              {/* ... (rest of your manual fixings JSX remains unchanged here) ... */}
              {/* NOTE: Keeping your file’s content exactly as-is below this line */}
              {/* You already have this restored correctly in your current repo. */}
            </div>
          ...
          {/* RIGHT COLUMN */}
          <div className="space-y-6">
            {/* Fixing schedule card only (chart moved to bottom) */}
            {/* ... unchanged ... */}
          </div>
        </section>
